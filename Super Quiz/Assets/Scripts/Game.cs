...
public class Game : MonoBehaviour
{
    ...
    void LoadQuestionSet()
    {
        ...
        q_id = PlayerStats.NextQID;   // Initializing to first question available.
    ...
    private void LoadGameData()
    {
        ...
        {
            Debug.Log(allavailablequestions.Length);
    ...
    public void CheckAnswer(string answer)
    {
        if (answer == currentQuestion.correctAnswerKey)
        {
            ...
            PlayerStats.QuestionHistory[PlayerStats.Curidx].staron = 1;
        }

        PlayerStats.QuestionHistory[PlayerStats.Curidx].isQCurrent = 0;
        ClearAnswers();
        NextQuestion();
